        # Metasprint Autopilot: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metasprint-autopilot.git

        ## Objective

        MetaSprint Autopilot is a 30K-line automated meta-analysis pipeline for rapid evidence synthesis across clinical domains, with ~2,300 total validated tests.
        ...
        - Code: https://github.com/mahmood726-cyber/metasprint-autopilot.git
